                      ...
                      {isAdmin && (
                        <td className="table__actions">
                          {withdrawingId === type.id ? (
                            <span role="group" aria-label={`Confirmar retiro de ${type.name}`}>
                              ¿Retirar «{type.name}»? {WITHDRAW_EXPLANATION}{" "}
                              <button
                                type="button"
                                className="button button--secondary"
                              ...
                              <button
                                type="button"
                                className="button button--primary"
                                onClick={() => handleSetActive(type.id, false)}
                                disabled={isSavingAction}
                              >
                                {isSavingAction ? "Retirando…" : "Sí, retirar"}
                              </button>
                            </span>
                          ) : renamingId === type.id ? (
                            <>
