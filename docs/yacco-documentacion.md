...
| **PaymentMethod**            | Catálogo de formas de cobro: efectivo, transferencia, Yape, Plin.                                | id, name, active                                                                                                                    | 0..* Payment; base del reporte de cobranza por tipo.     |
| **Payment**                  | Abono que reduce la deuda monetaria; siempre con medio de pago.                                  | id, customer, sale (opcional), routeStop (opcional), paidAt, amount, paymentMethod, recordedBy                                      | —                                                        |
| **RouteSettlement**          | Conciliación de envases y dinero al cierre de la ruta.                                           | route, fullOut, fullDelivered, fullSold, fullReturned, emptiesCollected, totalSold, totalCollected, totalOnCredit, notes, settledBy | 1–1 con Route.                                           |
