...
operativas se cargaron en producción con datos de prueba (ítem K del cierre
final); los datos reales los carga la planta siguiendo el documento de limpieza del ítem K.
...
| Precios de lista (operativa)                                                                        | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
...
| ¿Sabe cuántos bidones tiene cada cliente? (operativa)                                               | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
| ¿Cuántos envases tiene hoy la planta? (operativa)                                                   | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
...
| ¿Cómo reparte a los clientes de Parque? (operativa)                                                 | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
| Días de reparto (operativa)                                                                         | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
...
| Choferes y oficina (operativa)                                                                      | —                         | Cargado con datos de prueba (ítem K); los reales se cargan en la limpieza | Se carga en la app |
