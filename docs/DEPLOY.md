...
> **Estado:** las fases 2 a 5 todavía no están construidas. Los comandos
...
pnpm deploy:api               # producción: servicio yacco-api, rama main de Neon
```
...
**Siempre demo primero, verificar, y recién entonces producción.**

### El web _(fase 4)_

Lo despliega CI al mergear a `main`. A mano, cuando haga falta:
